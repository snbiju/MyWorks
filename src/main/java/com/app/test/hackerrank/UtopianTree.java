...
public class UtopianTree {
    ...
    public static List<Integer> countOfSmallerNumberII(int[] nums) {
        ...
        for (int ii = 1; ii < A.size(); ii++) {
            ...
            // (int) (A.get(ii)));
            int num = findIndex(tempList, A.get(ii));
     ...
     * the shortest transformation sequence from start to end, such that: <br>
     ...
     * <b>Input</b> {@code [2, 2, 2, 2, 2]}, <br>
     * <b>Output</b>: <b>5</b> <br>
     * <b>Explanation</b>: The length of the longest continuous increasing
